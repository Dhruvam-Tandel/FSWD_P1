...
const getMoviesByTitleLengthDescending = (collection) => {
    return collection
        .map(movie => ({ title: movie.title, length: movie.title.length }))
        .sort((a, b) => b.length - a.length);

};
console.log(getMoviesByTitleLengthDescending(movies));